                ...
                <div className="flex-col md:flex md:flex-row">
                    <div className="flex text-white bg-purple-900  rounded-tl-2xl rounded-tr-2xl ">
                        <div className="flex flex-wrap pl-8 md:pl-0 py-4 font-bold">
                            ...
                            >
                                <h2 class="font-bold px-4 py-1 text-lg">
                                    2011
                                </h2>
                            </button>
                            <button
                ...
                <div className="grid flex-col lg:grid-cols-4 bg-indigo-900 lg:rounded-tr-2xl lg:rounded-br-2xl  lg:rounded-bl-2xl">
                    ...
                    <div className="flex-col lg:col-span-2 lg:p-5 p-2 space-y-3 text-white">
                        ...
                        <h2 className="text-lg lg:text-xl font-athiti px-8">
                            La cantidad de tipos de articulos exportados por la
                            Región de Los Ríos, se ha ido expandiendo con el
                            paso de los años, lo cual es visible en los gráficos
                            de redes, en donde cada pequeño nodo representa un
                            tipo de articulo y su color representa su índice de
                            RCAe, simbolizando con verde aquellos que posee un
                            RCAe mayor a 1 y con rojo a los que no.
                        </h2>
                        <div className="flex flex-col px-10 mb-12">
                            ...
                            >
                                → Fuente de datos: Repositorio público{" "}
                                <i>datos.gob.cl</i>
                            </a>
                            <a
                                href="#"
                        ...
                        <div className="flex-col space-y-4 text-white  ml-6 py-5">
                            ...
                            <h2 className="text-lg lg:text-xl font-athiti px-2">
                                Dentro de las secciones con más tipos de
                                exportaciones las más destacadas son la N°1,
                                N°2, N°4, N°9 y N°16.
                            </h2>
                        </div>
