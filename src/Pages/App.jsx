                                ...
                                <div className="col-span-1 lg:col-span-3 px-10">
                                    ...
                                    >
                                        <p className="fadetext">
                                            Este proyecto es el resultado final
                                            de un trabajo de tesis para optar al
                                            título de Ingeniero Civil Industrial
                                            en la UACH de Manuel Huala, esta
                                            idea surge ante la necesidad de una
                                            plataforma que a través de la
                                            visualización de datos pueda
                                            soportar la toma de decisiones de
                                            inversión para los distintos actores
                                            dentro de Los Ríos.
                                        </p>
                                        <p className="fadetext">
                                            El proyecto es realizado bajo el
                                            alero de HUB Los Ríos, proyecto
                                            perteneciente a la Corporación
                                            Regional de Desarrollo Productivo
                                            que permite facilitar el nexo entre
                                            proyectos de innovación y empresas,
                                            con el apoyo y monitoreo del
                                            encargado de atracción de
                                            inversiones Don Ronald Miranda y el
                                            constante apoyo del profesor
                                            patrocinante de este trabajo Don
                                            Luis Vidal.
                                        </p>
                                    </div>
                                    {/* Contenido 2 */}
                                    ...
                                    >
                                        <p className="fadetext">
                                            En este DSS se puede encontrar
                                            información de diversa índole a
                                            nivel regional y comunal para Los
                                            Ríos, todos estos datos están
                                            relacionados de una u otra forma a
                                            variables relevantes a la hora de
                                            invertir en un territorio (según
                                            distintos estudios, expuestos en el
                                            trabajo de título).
                                        </p>
                                        <p className="fadetext">
                                            Por un lado se tienen
                                            visualizaciones de datos, las cuales
                                            pueden ser descargadas como imagen y
                                            como archivo de valores separados
                                            por coma (.csv), el cuál puede ser
                                            trabajado con MS Excel u otro
                                            software para un análisis más
                                            detallado. También pueden realizarse
                                            un análisis exhaustivo a cada tipo
                                            de artículo exportado por Los Ríos
                                            según los registros de Aduanas
                                            durante el periodo 2010-2021 viendo
                                            cuales poseen una _______ (VCRe
                                            mayor a 1). Finalmente se puede
                                            hacer una simulación del efecto
                                            desagregado de una variación en la
                                            demanda final de algún sector
                                            productivo de Los Ríos, observando
                                            como variarían también las demandas
                                            finales de los otros sectores según
                                            sus encadenamientos (con datos del
                                            2020).
                                        </p>
                                    </div>
                                    {/* Contenido 3 */}
                                    ...
                                    >
                                        <p className="fadetext ">
                                            Para las visualizaciones de datos
                                            comunales, de exportaciones y
                                            regionales (exceptuando las
                                            vocaciones productivas) se
                                            utilizaron datos de las siguientes
                                            fuentes: CONASET, SEIA, SII, Banco
                                            Central, INE, SUBTEL, Datos.gob.cl
                                            (aduanas).
                                        </p>
                                        <p className="fadetext ">
                                            Las vocaciones productivas, los
                                            datos utilizados para calcular las
                                            MIP de Los Ríos así como sus
                                            encadenamientos productivos y fueron
                                            extraídas de documentos cómo FIC-R y
                                            FIC-R.
                                        </p>
                                        <p className="fadetext ">
                                            Estos datos a su vez fueron
                                            trabajados y analizados según la
                                            metodología, estando algunas
                                            disponibles en los siguientes
                                            repositorios públicos para la
                                            revisión de cualquier usuario de la
                                            plataforma interesado.
                                        </p>
                                    </div>
                                </div>
                            </div>
