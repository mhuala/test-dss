  ...
  return (
    <div className="container mx-auto px-4 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 md:rounded-tl-2xl rounded-bl-2xl rounded-br-2xl bg-indigo-900 ">
        {/*- Info Card -*/}
        <div className="col-span-1 md:col-span-2 p-5 md:p-8 space-y-3 text-white h-96">
          {listGraph.map((e, i) => (
            <Fragment>
              <div
                className={
              ...
              >
                ...
                <p className="fadetext text-xl font-athiti">{e[3]}</p>
              </div>
            </Fragment>
          ))}
        </div>
            ...
            {listGraph.map((listGraphItem, index) => {
              switch (listGraphItem[0]) {
                case "tree":
                  ...
                  tree_series.series = listGraphItem[1].series;
                  return (
                    <div
                      className={
                        graph === index + 1
                ...
                case "area":
                  ...
                  area_series.series = listGraphItem[1].series;
                ...
                case "bar_h":
                  ...
                  bar_h_series.series = listGraphItem[1].series;
                  return (
                    <div
                      className={
                        graph === index + 1
                ...
                case "bar_v":
                  ...
                  bar_v_series.options.xaxis.categories =
                    listGraphItem[1].categories;
                  //  bar_series.series = bar_l[1].series;
                  bar_v_series.series = listGraphItem[1].series;
                  return (
                    <div
                      className={
                        graph === index + 1
                ...
                case "heat":
                  ...
                  heat_series.series = listGraphItem[1].series;
                  return (
                    <div
                      className={
                        graph === index + 1
                ...
                case "line":
                  //  heat_series.series = heat_l[1].series;
                  line_series.series = listGraphItem[1].series;
