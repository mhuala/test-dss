            ...
            <div className="text-white grid col-span-1 xl:col-span-3">
                <div className="ml-2 p-3 flex flex-col justify-center max-w-4xl rounded bg-brand space-y-10">
                    ...
                    <div className="mt-4 text-gray-400 text-lg px-8 md:px-14 md:text-2xl font-athiti font-extrabold">
                        Esta iniciativa de visualización de datos como sistema
                        de soporte a la toma de decisiones (DSS en inglés), es
                        una iniciativa complementaria a la Politica Regional de
                        Fomento que comprende el periodo 2021-2026. Con esta
                        herramienta se busca concentrar información para el uso
                        del público general y principalmente para inversores,
                        los que finalmente pueden observar la estructura
                        economica y productiva de las comunas pudiendo incluso
                        simular los efectos desagregados de una diferencia en la
                        demanda total de algún sector productivo de la región.
                    </div>
                </div>
            </div>
            {/* Right Image */}
